    ...
    <br> <br> 
               ...
               ?>
                     ...
                     <?php
                      include('config.php');
                       ...
                       $sql = "SELECT * FROM tbl_entrepreneurship WHERE id=$id";
     ...
     <div class="voting-payment">
      <div class="content">
         ...
         <div class="imgBx">
          <img src="<?php echo SITEURL; ?>/entrepreneurship/<?php echo $contestant_image; ?>" width="100px">
         </div>
          </div>

          <div class="content">
            <form id="paymentForm" action="pay3.php" method="POST">
                ...
                <!--   <label for="first-name">Contestant Name</label> -->
                 ...
                 <div class="form-submit">
                  <button name="sub"> Make Payment </button>
                </div>
              </form>
