              ...
              <?php
               include('config.php');
                // Creating query to display data from database 
                 $sql = "SELECT * FROM tbl_entrepreneurship";
                 ...
                 if($count>0)
                 {
                   // Category Available
                    while($row=mysqli_fetch_assoc($res))
                    {
                       ...
                       <a href="<?php echo SITEURL; ?>voting-payment-entrepreneurship.php?contestant_id=<?php echo $id; ?>">
                         <div class="imgBx">
                            <?php
                            // Checking whether image is available or not, If not checked we may encounter error if there is no image.= available.
                               ...
                               {
                                ?>
                                 <img src="<?php echo SITEURL; ?>/entrepreneurship/<?php echo $contestant_image; ?>" 
